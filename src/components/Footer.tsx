    ...
    <footer className="p-1 w-full h-auto md:h-[80vh] bg-[#0f1d3e] text-[rgb(54,62,77)] flex justify-center items-center">
      <div className="w-[85%] h-[99%] flex flex-col items-center">
        <div className="w-full h-[15vh] md:h-[25%] flex items-center justify-between">
          <div className="w-1/3 h-10 flex gap-2 items-center text-[rgb(208,153,53)]">
            <img
          ...
          <div className="w-1/4 h-10 flex items-center justify-end gap-3">
            <div className="w-8 h-8 bg-[rgb(208,153,53)] flex items-center justify-center rounded-full flex-none">
              <Image src={fblogo} alt="F" className="w-7 h-7 object-contain" />
            </div>
            <div className="w-8 h-8 bg-white flex  rounded-full justify-center items-center flex-none">
              <Image
                src={instaLogo}
                alt="F"
        ...
        <div className="w-full h-[60%] pt-4 border-t-[1.5px] flex justify-between items-center border-b-[1.5px] border-[rgb(54,62,77)]">
          <div className="w-full h-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
            <div className="h-full py-3 flex flex-col gap-3">
              <p className="text-[rgb(157,165,178)] text-base font-bold">
                Next.JS
              </p>
              <p className="text-[rgb(79,87,102)] text-sm font-light">About</p>
              <p className="text-[rgb(79,87,102)] text-sm font-light">Home</p>
              <p className="text-[rgb(79,87,102)] text-sm font-light">
                Pricing
              </p>
              <p className="text-[rgb(79,87,102)] text-sm font-light">
                Pro Version
            ...
            <div className="h-full py-3 flex flex-col gap-3">
              ...
              <p className="text-[rgb(79,87,102)] text-sm font-light">FAQs</p>
              <p className="text-[rgb(79,87,102)] text-sm font-light">
                Quick Start
              </p>
              <p className="text-[rgb(79,87,102)] text-sm font-light">
            ...
            <div className="h-full py-3 flex flex-col gap-3 md:col-span-2 lg:col-span-2 xl:col-span-2">
              ...
              <div className="w-full h-3/5 bg-[rgb(32,41,56)] rounded-4xl flex flex-col gap-2 p-5">
                ...
                <div className="w-full flex items-center h-[15vh] sm:h-3/4 md:w-full gap-1">
                  <input
                    className="w-4/5 h-8 rounded-4xl px-4 text-sm border-2 outline-0 border-gray-500 text-[rgb(107,116,134)] placeholder-[rgb(107,116,134)]"
                    type="email"
                    placeholder="mail@email.com"
                    aria-label="Email address"
                  />

                  <div className="w-15 h-8 bg-[rgb(208,153,53)] flex justify-center items-center text-white rounded-md">
                    Send
                  </div>
                </div>
              </div>
